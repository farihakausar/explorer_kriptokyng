          ...
          <div className="flex flex-col items-center space-y-6 text-center">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
                {t("home.welcome") || `Welcome to ${siteConfig.name}`}
              </h1>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                {t("home.tagline") || "The most efficient and reliable mining pool for Kriptokyng"}
              </p>
            </div>
          ...
          <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-sm font-medium">{t("home.stats.miners") || "Miners"}</h3>
              </div>
            ...
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-sm font-medium">{t("home.stats.hashrate") || "Hashrate"}</h3>
              </div>
            ...
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-sm font-medium">{t("home.stats.blocks_found") || "Blocks Found"}</h3>
              </div>
            ...
            <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-sm font-medium">{t("home.stats.uptime") || "Uptime"}</h3>
              </div>
